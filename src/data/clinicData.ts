...
export const DOCTORS: Doctor[] = [
  {
    ...
    bio: 'پژوهشگر حوزه روانشناسی اجتماعی. موسس و مدیر کلینیک روانشناسی ژینو.',
    specialties: [],
    gender: 'female',
    active: true,
    sessionTypes: [],
    ...
    bookable: false,
    sortOrder: 1,
    tags: ['مدیریت کلینیک', 'روانشناسی اجتماعی'],
  },
  {
    id: 'dr-molazem',
    ...
    bio: 'مسئول هماهنگی امور داخلی و اجرایی کلینیک ژینو.',
    specialties: [],
    gender: 'female',
    active: true,
    sessionTypes: [],
  ...
  },
  {
    ...
    bio: 'حوزه فعالیت: اختلالات یادگیری و روانسنجی.',
  ...
  },
  {
    ...
    bio: 'حوزه مشکلات رفتاری و اضطرابی کودکان و نوجوانان.',
  ...
  },
  {
    ...
    bio: 'درمانگر حوزه روانشناسی سلامت و مسائل زناشویی.',
  ...
  },
  {
    ...
    bio: 'مشاور توسعه فردی و خانواده، اختلالات هیجانی-رفتاری و مشاوره شغلی.',
  ...
  },
  {
    ...
    bio: 'مشاور فردی، نوجوانان و زوجین؛ مشاوره پیش از ازدواج و گروه درمانگر.',
  ...
  },
  {
    ...
    bio: 'پژوهشگر حوزه سلامت روان دیجیتال و روانسنج. پشتیبان جلسات آنلاین کلینیک.',
  ...
  },
  {
    ...
    bio: 'مدرس رسمی آموزش خانواده در آموزش و پرورش؛ مشاوره فردی، مشاور تحصیلی و درمانگر حیطه وسواس.',
  ...
  },
  {
    ...
    bio: 'روانشناس کودک و نوجوان با تمرکز بر حوزه اوتیسم.',
    specialties: ['child'],
    gender: 'female',
    active: true,
    sessionTypes: ['in-person'],
