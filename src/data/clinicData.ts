...
export const CLINIC_INFO = {
  ...
  phone2Clean: '02188774433',
  address:
    'تهران، خیابان شهید کلاهدوز، ابتدای خیابان مطهری، جنب بانک شهر، مجتمع نگین، پلاک ۱، طبقه اول، واحد ۵',
  /** Leave empty until the clinic confirms the real inbox; placeholders open wrong destinations. */
  email: '',
  hoursSatToWed: '۹:۰۰ الی ۱۶:۰۰',
  hoursThu: '',
  hoursText: 'شنبه تا چهارشنبه ۹ الی ۱۶ | حضوری و آنلاین',
  /** Confirmed handles only — empty until clinic provides real accounts. */
  instagram: '',
  telegram: '',
  whatsappNumber: '',
  /** Prefer address-text map search; previous pin resolved to the wrong street. */
  mapLat: undefined as number | undefined,
  mapLng: undefined as number | undefined,
};

export const DOCTORS: Doctor[] = [
  {
    id: 'dr-jalali',
    name: 'خانم بی‌نظیر جلالی',
    title: 'موسس و مدیر کلینیک ژینو',
    degree: 'دکتری روانشناسی سلامت',
    avatar: '/staff/dr-jalali.jpg',
    bio: 'موسس و مدیر کلینیک ژینو؛ پژوهشگر حوزه روانشناسی اجتماعی.',
    specialties: [],
    gender: 'female',
    active: true,
    sessionTypes: [],
    ...
    bookable: false,
    sortOrder: 1,
    tags: ['موسس و مدیر', 'روانشناسی اجتماعی'],
  },
  {
    id: 'dr-molazem',
    name: 'خانم اعظم ملازم',
    title: 'مدیر داخلی و امور اجرایی کلینیک',
    degree: 'کارشناس ارشد علوم ارتباطات',
    avatar: '/staff/dr-molazem.jpg',
    bio: 'مدیر داخلی و امور اجرایی کلینیک ژینو.',
    specialties: [],
    gender: 'female',
    active: true,
    sessionTypes: [],
    ...
    bookable: false,
    sortOrder: 2,
    tags: ['مدیر داخلی', 'امور اجرایی'],
  },
  {
    id: 'dr-afshar',
    name: 'خانم زهره افشار',
    title: 'روانشناس کودک و روانسنج',
    degree: 'دکتری روانشناسی و آموزش کودکان استثنایی',
    avatar: '/staff/dr-afshar.jpg',
    bio: 'اختلالات یادگیری و روانسنجی.',
    specialties: ['child', 'assessment'],
    gender: 'female',
    active: true,
    ...
    bookable: true,
    sortOrder: 10,
    tags: ['اختلالات یادگیری', 'روانسنجی'],
  },
  {
    id: 'dr-homayounian',
    name: 'خانم بدرالسادات همایونیان',
    title: 'روانشناس کودک و نوجوان',
    degree: 'کارشناس ارشد روانشناسی و آموزش کودکان استثنایی',
    avatar: '/staff/dr-homayounian.jpg',
    bio: 'حوزه مشکلات رفتاری و اضطرابی کودکان و نوجوانان؛ روانشناس کودک و نوجوان.',
    specialties: ['child', 'digital'],
    gender: 'female',
    active: true,
    sessionTypes: ['in-person'],
    role: 'specialist',
    bookable: true,
    sortOrder: 11,
    tags: ['مشکلات رفتاری', 'اضطراب کودک و نوجوان'],
  },
  {
    id: 'dr-deihimi',
    name: 'خانم مرجانه دیهیمی',
    title: 'روانشناس سلامت و مسائل زناشویی',
    degree: 'دکتری تخصصی روانشناسی سلامت و مسائل زناشویی',
    avatar: '/staff/dr-deihimi.jpg',
    bio: 'دکتری تخصصی روانشناسی سلامت و مسائل زناشویی.',
    specialties: ['family', 'individual'],
    gender: 'female',
    active: true,
    ...
    bookable: true,
    sortOrder: 12,
    tags: ['روانشناسی سلامت', 'مسائل زناشویی'],
  },
  {
    id: 'dr-ghadyani',
    name: 'خانم مرجان قدیانی',
    title: 'مشاور توسعه فردی و خانواده',
    degree: 'کارشناس ارشد روانشناسی بالینی',
    avatar: '/staff/dr-ghadyani.jpg',
    bio: 'مشاور توسعه فردی و خانواده و اختلالات هیجانی-رفتاری؛ مشاوره شغلی.',
    specialties: ['family', 'individual', 'career'],
    gender: 'female',
    active: true,
    sessionTypes: ['in-person', 'online'],
    role: 'specialist',
    bookable: true,
    sortOrder: 13,
    tags: ['توسعه فردی', 'خانواده', 'مشاوره شغلی'],
  },
  {
    id: 'dr-nejad-hosseini',
    name: 'خانم سعیده نژاد حسینی',
    title: 'مشاور فردی، نوجوانان و زوجین',
    degree: 'دکتری روانشناسی سلامت',
    avatar: '/staff/dr-nejad-hosseini.jpg',
    bio: 'مشاور فردی، نوجوانان و زوجین؛ مشاوره پیش از ازدواج؛ گروه درمانگر.',
    specialties: ['individual', 'family', 'child', 'digital'],
    gender: 'female',
    active: true,
    sessionTypes: ['in-person', 'online'],
    role: 'specialist',
    bookable: true,
    sortOrder: 14,
    tags: ['پیش از ازدواج', 'گروه درمانی', 'نوجوانان'],
  },
  {
    id: 'dr-sajedi',
    name: 'خانم تینا ساجدی',
    title: 'مشاور خانواده و روانسنج',
    degree: 'کارشناس ارشد مشاوره خانواده',
    avatar: '/staff/dr-sajedi.jpg',
    bio: 'پژوهشگر؛ حوزه سلامت روان دیجیتال؛ روانسنج. پشتیبان جلسات آنلاین کلینیک.',
    specialties: ['family', 'assessment', 'digital'],
    gender: 'female',
    active: true,
    sessionTypes: ['online'],
    role: 'specialist',
    ...
    onlineSupport: true,
    sortOrder: 15,
    tags: ['سلامت روان دیجیتال', 'روانسنجی', 'پشتیبان آنلاین'],
  },
  {
    id: 'dr-shaghaghi',
    name: 'خانم پروانه شقاقی',
    title: 'مشاور فردی و تحصیلی',
    degree: 'دکتری روانشناسی سلامت',
    avatar: '/staff/dr-shaghaghi.jpg',
    bio: 'مدرس رسمی آموزش خانواده در آموزش و پرورش؛ مشاوره فردی؛ مشاور تحصیلی؛ درمانگر حیطه وسواس.',
    specialties: ['individual', 'cbt', 'career'],
    gender: 'female',
    active: true,
    sessionTypes: ['in-person', 'online'],
    role: 'specialist',
    bookable: true,
    sortOrder: 16,
    tags: ['آموزش خانواده', 'مشاوره تحصیلی', 'وسواس'],
  },
  {
    id: 'dr-azizi',
    name: 'خانم ماه‌منیر عزیزی',
    title: 'روانشناس کودک و نوجوان',
    degree: 'دکتری روانشناسی کودکان استثنایی',
    avatar: '/staff/dr-azizi.jpg',
    bio: 'روانشناس کودک و نوجوان؛ حوزه اوتیسم.',
    specialties: ['child'],
    gender: 'female',
    active: true,
    sessionTypes: ['in-person'],
...
export const MAIN_SERVICES: ServiceItem[] = [
  ...
  {
    id: 'digital-tech-counseling',
    title: 'مشاوره فناورانه',
    description:
      'آسیب‌شناسی فضای مجازی، آموزش والدگری در عصر دیجیتال، پرورش سلامت روان دیجیتال، سواد رسانه و مشاوره فناورانه.',
    icon: 'devices',
    badge: 'جدید',
    format: 'حضوری و آنلاین',
    bgClass: 'bg-surface-container-high',
...
export const DEFAULT_FAQS: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'مراجعه‌کنندگان محترم می‌توانند تا ۲۴ ساعت قبل از زمان تعیین‌شده با تماس با پشتیبانی، نوبت خود را تغییر داده یا جابه‌جا کنند.',
...
export const DEFAULT_WORKSHOPS = [
  {
    ...
    description:
      'پوستر کارگاه‌های پیش‌رو را مشاهده کنید و برای ثبت‌نام با شماره تماس کلینیک هماهنگ شوید.',
    posterUrl: '',
