...
export const BUILTIN_NAV_TARGETS: Array<{ value: string; label: string }> = [
  ...
  { value: 'workshops', label: 'کارگاه‌ها' },
...
export const DEFAULT_SITE_CHROME: SiteChromeSettings = {
  ...
  menu: {
    ...
    mainItems: [
      ...
      { id: 'nav-workshops', label: 'کارگاه‌ها', target: 'workshops', visible: true },
  ...
  footer: {
    ...
    quickLinks: [
      ...
      { id: 'f-workshops', label: 'ثبت‌نام کارگاه‌ها', target: 'workshops', visible: true },
